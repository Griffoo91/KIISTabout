          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="text-center">
              ...
              <p className="text-gray-700 mb-3">
                Kisii Impact of Science and Technology College is dedicated to inspire and help learners develop intellect and character, desirable skills, knowledge and attitudes responsive to the challenges of a dynamic society.
              </p>
              <div className="w-20 h-1 bg-red-500 mx-auto my-4 rounded"></div>
              <p className="text-gray-600">
                We are the leading TVET & Medical institution in Kenya, well known for our exciting approach to tertiary education and training. We boast modern state-of-the-art facilities, dynamic approach to teaching, and vibrant co-curriculum schedule for our students.
                We offer Advanced Diploma, Diploma, Certificate, Artisan, Short Courses & Driving. Through our brand promise, Quality Education, we produce effective professionals in diverse fields giving them a competitive advantage.  For the last decade, over 50,000 students have graduated and taken successful career paths nationally and internationally.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <img src={about1} alt="About" className="rounded-xl shadow-md" />
              <img src={about2} alt="About" className="rounded-xl shadow-md" />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <InfoCard title="Why Choose Us?">
              <ul className="list-disc pl-5 space-y-1 text-left">
                ...
                <li>Indoor and outdoor activities e.g. football, volleyball, table tennis, pool table, darts, CU and CA.</li>
            ...
            <InfoCard title="Our Mission">
              Kisii Impact Institute of Science and Technology is dedicated to inspire and help learners develop intellect and character, desirable skills, knowledge and attitudes responsive to the challenges of a dynamic society.
            </InfoCard>
          </div>
        </section>
